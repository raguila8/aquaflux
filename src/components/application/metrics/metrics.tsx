  ...
  return (
    <div
      className={cx(
        ...
        type === 'modern' &&
          'ring-secondary shadow-inner-blur rounded-md bg-[linear-gradient(rgba(9,9,11,0.66),rgba(9,9,11,0.66)),linear-gradient(#07344550,#07344550)] py-0.5 pr-2 pl-1.5 ring-1 ring-inset',
        className
      )}
    >
      <Icon
...
export const MetricsSimple = ({
  ...
  footer?: ReactNode
  /**
   * Whether to show the actions (dots) dropdown.
  ...
  return (
    <div
      className={cx(
        'ring-secondary shadow-inner-blur-secondary rounded-xl bg-[linear-gradient(rgba(9,9,11,0.66),rgba(9,9,11,0.66)),linear-gradient(#07344550,#07344550)] ring-1 ring-inset',
        className
      )}
    >
      <div className='relative flex flex-col gap-2 px-4 py-5 md:px-5'>
        ...
        <div className='flex items-end gap-4'>
          <p className='text-display-sm text-primary_on-brand flex-1 font-semibold'>
            {title}
          </p>
...
export const MetricsIcon01 = ({
  ...
  return (
    <div
      className={cx(
        'bg-primary ring-secondary rounded-xl shadow-xs ring-1 ring-inset',
        className
      )}
    >
      <div className='relative flex flex-col gap-4 px-4 py-5 md:gap-5 md:px-5'>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <div className='flex items-end gap-4'>
            <p className='text-display-sm text-primary flex-1 font-semibold'>
              {title}
            </p>
