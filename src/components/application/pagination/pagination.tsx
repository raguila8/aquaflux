  ...
  return (
    <Pagination.Item
      ...
      className={({ isSelected }) =>
        cx(
          'text-quaternary outline-focus-ring hover:shadow-inner-blur-no-border hover:bg-secondary_subtle/95 hover:text-secondary focus-visible:bg-primary_hover relative flex size-10 cursor-pointer items-center justify-center p-3 text-sm font-medium transition duration-100 ease-linear focus-visible:z-10 focus-visible:outline-2 focus-visible:outline-offset-2',
          rounded ? 'rounded-full' : 'rounded-lg',
          isSelected &&
            'shadow-inner-blur-secondary! after:border-indigo-blue-200/[.03] text-secondary bg-[linear-gradient(rgba(9,9,11,0.66),rgba(9,9,11,0.66)),linear-gradient(#07344550,#07344550)] after:absolute after:inset-0 after:rounded-lg after:border'
        )
      }
    >
      {value}
