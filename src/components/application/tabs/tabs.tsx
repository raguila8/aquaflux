...
const getTabStyles = ({
  ...
  'button-minimal': cx(
    ...
    isFocusVisible && 'outline-2 -outline-offset-2',
    isSelected &&
      'bg-[linear-gradient(rgba(9,9,11,0.66),rgba(9,9,11,0.66)),linear-gradient(#07344550,#07344570)] text-secondary ring-1 ring-primary ring-inset shadow-btn-secondary'
  ),
  underline: cx(
...
const getHorizontalStyles = ({
  ...
  'button-minimal':
    'relative after:absolute after:inset-0 after:rounded-lg after:border after:border-indigo-blue-200/[.03] shadow-inner-blur gap-0.5 rounded-lg bg-primary',
