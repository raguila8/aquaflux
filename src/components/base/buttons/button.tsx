...
export const styles = sortCx({
  common: {
    root: [
      'group relative inline-flex h-max cursor-pointer items-center justify-center whitespace-nowrap outline-brand transition duration-200 ease-linear before:absolute focus-visible:outline-2 focus-visible:outline-offset-2',
  ...
  sizes: {
    ...
    md: {
      root: [
        'gap-1.5 rounded-lg px-3.5 py-2.5 text-sm font-semibold before:rounded-[7px] data-icon-only:p-2.5',
  ...
  colors: {
    primary: {
      root: [
        "shadow-btn-primary text-aqua-50 bg-btn-primary after:content-[''] after:absolute after:inset-0 after:size-full after:bg-btn-primary-hover after:opacity-0 after:transition-all after:duration-200 hover:after:opacity-100 after:shadow-btn-primary-hover after:rounded-lg data-loading:bg-brand-solid_hover",
        // Disabled styles
        'disabled:bg-disabled disabled:shadow-xs disabled:ring-disabled_subtle',
        // Icon styles
        '*:data-icon:text-slate-200/90 hover:*:data-icon:text-indigo-blue-100',
      ].join(' '),
    },
    secondary: {
      root: [
        "shadow-btn-secondary bg-indigo-blue-600/[.01] text-indigo-blue-50 hover:bg-indigo-blue-900/[0.03] hover:text-white after:content-[''] after:absolute after:inset-0 after:w-full after:h-full after:opacity-0 after:transition-all after:duration-200 hover:after:opacity-100 after:shadow-btn-secondary-hover after:rounded-lg data-loading:bg-primary_hover",
        // Disabled styles
