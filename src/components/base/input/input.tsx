  ...
  return (
    <AriaGroup
      ...
      className={({ isFocusWithin, isDisabled, isInvalid }) =>
        cx(
          'bg-primary/95 ring-primary relative flex w-full flex-row place-content-center place-items-center rounded-lg shadow-xs ring-1 transition-shadow duration-100 ease-linear ring-inset',

          isFocusWithin && !isDisabled && 'ring-indigo-blue-300/15 ring-2',
